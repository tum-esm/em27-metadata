...
def test_datetime_parsing() -> None:
    assert em27_metadata.types.TimeSeriesElement.matches_datetime_regex("2016-10-01T00:00:00+0000")
    assert em27_metadata.types.TimeSeriesElement.matches_datetime_regex("2016-10-01T23:00:00+0000")
    assert em27_metadata.types.TimeSeriesElement.matches_datetime_regex("2016-10-01T00:00:00+0100")
...
def test_time_series_element() -> None:
    tse1 = em27_metadata.types.TimeSeriesElement(
        from_datetime="2016-10-01T00:00:00+0000",
        to_datetime="2016-10-01T22:59:59+0200",
    )
    ...
    tse2 = em27_metadata.types.TimeSeriesElement(
        from_datetime="2016-10-01T00:00:00+0000", to_datetime="2016-10-03T13:24:59-0530"
    )
