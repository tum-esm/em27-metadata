...
def test_datetime_parsing() -> None:
    assert em27_metadata.types.TimeSeriesElement.matches_datetime_regex("2016-10-01T00:00:00+00:00")
    assert em27_metadata.types.TimeSeriesElement.matches_datetime_regex("2016-10-01T23:00:00+00:00")
    assert em27_metadata.types.TimeSeriesElement.matches_datetime_regex("2016-10-01T00:00:00+01:00")
    assert not em27_metadata.types.TimeSeriesElement.matches_datetime_regex("2016-10-01T00:00:00+00:0")
